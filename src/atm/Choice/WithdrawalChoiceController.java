 ...
 */
public class WithdrawalChoiceController implements AmountChoiceController
{
    ...
    public WithdrawalChoiceController(ATM atm, AccountInfo model, 
    ...
    {
        atm.processingAd();
        component.withdraw(model.accNum, model.cardTypeId, model.accPass,
                amount);
    }
